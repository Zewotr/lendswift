describe('Home Loan Happy Path (Salaried with Co-Applicant)', () => {
  beforeEach(() => {
    cy.visit('/');
    cy.fixture('valid-home-loan').as('loanData');
  });

  it('should complete a home loan application with co-applicant', function() {
